...
# run: nohup sh ./Experiment_Settings/run_Bootstrap_MAE_setting4.sh > ./Experiment_results/Bmae_k_5_pn/screen.log 2>&1 &

# Settings
gpu_id=0
batch_size=256
bootstrap_k=5
base_path="./Experiment_results/Bmae_k_5_pn" # remember to turn on pixelnorm
