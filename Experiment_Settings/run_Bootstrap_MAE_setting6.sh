...
# run: nohup sh ./Experiment_Settings/run_Bootstrap_MAE_setting6.sh > ./Experiment_results/Bmae_k_7_pn/screen.log --2>&1 &

# Settings
gpu_id=0
batch_size=256
bootstrap_k=7
base_path="./Experiment_results/Bmae_k_7_pn" # remember to turn on pixelnorm
