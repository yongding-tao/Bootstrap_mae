...
# run: nohup sh ./Experiment_Settings/run_Bootstrap_MAE_setting7.sh > ./Experiment_results/Bmae_k_8_pn/screen.log 2>&1 &

# Settings
gpu_id=1
batch_size=256
bootstrap_k=8
base_path="./Experiment_results/Bmae_k_8_pn" # remember to turn on pixelnorm
