...
# run: nohup sh ./Experiment_Settings/run_Bootstrap_MAE_setting5.sh > ./Experiment_results/Bmae_k_6_pn/screen.log 2>&1 &

# Settings
gpu_id=1
batch_size=256
bootstrap_k=6
base_path="./Experiment_results/Bmae_k_6_pn" # remember to turn on pixelnorm
