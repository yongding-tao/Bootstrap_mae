...
# run: nohup sh ./Experiment_Settings/run_Bootstrap_MAE_onlyloadencoder_setting1.sh > ./Experiment_results/Bmae_k_2_pn_onlyloadencoder/screen.log 2>&1 &
...
batch_size=256
bootstrap_k=2
base_path="./Experiment_results/Bmae_k_2_pn_onlyloadencoder" # remember to turn on pixelnorm
